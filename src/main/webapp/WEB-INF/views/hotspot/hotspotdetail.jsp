			...
			<div class="col s12 m8">
				<div class="card">
					<div class="card-title" style="padding: 5px;">
						<i class="material-icons">place</i> ${hotspot.name}</div>
					...
					<div class="card medium ">
						<div class="card-image" style="overflow: visible">
							<a href="/restaurant/detail/${restaurant.rid}"> 
								<img src="${restaurant.img}" style="height: 200px;"/>
							...
							<i class="material-icons Tiny">edit_location</i> ${restaurant.district}<br/>
							<i class="material-icons Tiny">local_dining</i> ${restaurant.mainMenu}<br/>
							<i class="material-icons Tiny">favorite</i> ${restaurant.loveCount }<br/>
							<i class="material-icons Tiny">comment</i> 리뷰수
							</div>
					</div>
				</div>
